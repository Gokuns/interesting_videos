...
"}")
    ...
    def showClusterVideos(self):
        ...
        self.c1v1MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0001.mp4")))
        self.c1v2MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0002.mp4")))
        self.c1v3MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0003.mp4")))
        self.c2v1MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0004.mp4")))
        self.c2v2MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0005.mp4")))
        self.c2v3MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0006.mp4")))
        self.c3v1MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0007.mp4")))
        self.c3v2MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0008.mp4")))
        self.c3v3MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0009.mp4")))
        self.c4v1MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0010.mp4")))
        self.c4v2MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0011.mp4")))
        self.c4v3MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0012.mp4")))
        self.c5v1MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0013.mp4")))
        self.c5v2MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0014.mp4")))
        self.c5v3MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0015.mp4")))
        self.c6v1MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0016.mp4")))
        self.c6v2MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0017.mp4")))
        self.c6v3MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0018.mp4")))
        self.c7v1MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0019.mp4")))
        self.c7v2MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0020.mp4")))
        self.c7v3MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0021.mp4")))
        self.c8v1MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0022.mp4")))
        self.c8v2MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0023.mp4")))
        self.c8v3MediaPlayer.setMedia(QMediaContent(QUrl.fromLocalFile(config.argument_defaults['export_path']+'/'+"scene-0024.mp4")))
