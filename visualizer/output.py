...
"\n"
"")
        self.centralwidget = QtWidgets.QWidget(NuScenesExplorer)
        self.centralwidget.setObjectName("centralwidget")
        self.verticalGroupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.verticalGroupBox.setGeometry(QtCore.QRect(200, 200, 411, 281))
        self.verticalGroupBox.setContextMenuPolicy(QtCore.Qt.PreventContextMenu)
        ...
        self.label.setGeometry(QtCore.QRect(240, 70, 301, 16))
    ...
    def retranslateUi(self, NuScenesExplorer):
        ...
        NuScenesExplorer.setWindowTitle(_translate("NuScenesExplorer", "MainWindow"))
        self.pushButton_2.setText(_translate("NuScenesExplorer", "Browse Annotated Videos"))
        self.pushButton_4.setText(_translate("NuScenesExplorer", "Explore t-SNE"))
        self.pushButton_3.setText(_translate("NuScenesExplorer", "Upload Video"))
        self.pushButton.setText(_translate("NuScenesExplorer", "Help"))
        self.label.setText(_translate("NuScenesExplorer", "Welcome to Our Video App!!!"))
