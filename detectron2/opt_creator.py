...
def create_opt(input='C:\\Users\\Goko\\Desktop\\part1235\\videos\\scene-0001.mp4'):
    parser = demo.get_parser()
    args = parser.parse_args(['--config-file','../configs/COCO-PanopticSegmentation/panoptic_fpn_R_101_3x.yaml',
                               '--video-input',input,
